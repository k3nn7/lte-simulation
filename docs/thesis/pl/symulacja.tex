...
\begin{figure}[ht]
	\centerline{\frame{\includegraphics[width=0.8\textwidth]{images/simulation_class.png}}}
...
\begin{figure}[ht]
	\centerline{\frame{\includegraphics[width=0.5\textwidth]{images/connectable_class.png}}}
